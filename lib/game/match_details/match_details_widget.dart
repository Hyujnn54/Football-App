...
/// create a component page to see the details of a match
/// team 1 vs team 2 ( ofc name and logo )
/// captins of each team ( creators )
/// locations and date and time
                  ...
                  children: [
                    Expanded(
                      child: StreamBuilder<TeamRecord>(
                        stream: TeamRecord.getDocument(widget.match!.team1Id!),
                        builder: (context, snapshot) {
                          ...
                          final columnTeamRecord = snapshot.data!;
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          dateTimeFormat(
                              "d/M h:mm a", widget.match!.dateTime!),
                          style: FlutterFlowTheme.of(context)
                              .bodySmall
                              .override(
                                font: GoogleFonts.inter(
                    ...
                    Expanded(
                      child: StreamBuilder<TeamRecord>(
                        stream: TeamRecord.getDocument(widget.match!.team2Id!),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
