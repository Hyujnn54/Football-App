...
/// make an interface to edit or update existing products where the admin can
/// change the name price description category and image
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              context.pushNamed(ShopadminWidget.routeName);
            },
          ),
          title: Text(
            'Edit Product',
