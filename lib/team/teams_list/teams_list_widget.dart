...
/// Create a mobile page that lists teams for a football match.
///
/// UI only, no backend logic.
///
/// The page must include:
/// - An AppBar titled "Match Teams".
/// - A scrollable list of team cards.
/// Each team card must display:
/// - Team name
/// - Number of players (current / max)
/// - Captain name
/// - A button labeled "View Team".
///
/// Use a simple and clean card-based layout.
class TeamsListWidget extends StatefulWidget {
  const TeamsListWidget({super.key});

  static String routeName = 'teams_list';
  static String routePath = '/teamsList';

  @override
  State<TeamsListWidget> createState() => _TeamsListWidgetState();
}
